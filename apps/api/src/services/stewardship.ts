...
// #20 — legacy.
export const LEGACY_QUERY = /\b(legacy|what (?:will )?remains?|outlast|outlive|after i'?m gone|future generations?|pass (?:it )?(?:on|forward|down)|mentor(?:ing|ship)?|preserve (?:knowledge|this|the)|build something that lasts|endur(?:e|ing)|the cathedral|what deserves to last)\b/i;

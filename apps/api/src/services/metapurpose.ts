 ...
 */
export const METAPURPOSE_QUERY = /\b(why does (?:that|this|it) (?:matter|really matter|ultimately matter)|what(?:'s| is) the (?:bigger|deeper|real|ultimate) (?:why|purpose|point|reason)|greater purpose|higher purpose|what(?:'s| is) it (?:all )?(?:for|in service of|ultimately about)|what (?:am i|are we) (?:really|ultimately) (?:doing this for|here for)|why (?:do|should) (?:i|we) (?:even )?(?:do|continue|keep going|bother)|deeper meaning|what(?:'s| is) the meaning (?:behind|of)|to what end|the why behind the why|what purpose does (?:this|that) serve|why continue|what(?:'s| is) (?:all )?(?:this|the) (?:progress|work|effort|of (?:this|it)) (?:ultimately|even|all) (?:for|about)|all (?:this|the) progress (?:ultimately )?for|ultimate purpose)\b/i;

 ...
 */
export const FLOURISHING_QUERY = /\b(flourish(?:ing)?|thrive|thriving|well[- ]?being|wellbeing|live (?:a )?(?:better|good|meaningful)|live better|quality of life|fulfil(?:l|ment|ling)?|truly happy|a (?:good|meaningful) life|what does success (?:really|truly|actually) (?:mean|look like)|am i (?:actually )?(?:happy|fulfilled|thriving)|life satisfaction|whole life|becoming more|best version of (?:myself|me|us)|human potential|is (?:this|it all) worth it|more than (?:just )?(?:money|work|success))\b/i;
